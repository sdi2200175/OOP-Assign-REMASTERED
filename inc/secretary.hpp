...
private:
  ...
  unsigned short department_code, regular_attendance, required_ects, mandatory_courses;
...
public:
  /**
   * @brief Construct a new secretary object by requesting input from the user
   * directly
   *
   */
  secretary();
  ...
  /**
   * @brief Construct a new secretary object without requesting user input
   * directly.
   *
   * @param department_name The name of the department managed by the secretary
   * object.
   * @param department_code The code of the department managed by the secretary
   * object.
   * @param regular_attendance The required amount of years one has to attend
   * the department in order to get their diploma.
   * @param required_ects The ects required by an attendee of the department
   * managed by the secretary object to graduate.
   * @param mandatory_courses The amount of courses in the department managed by
   * the secretary object that are needed for graduation.
   */
  secretary(const std::string &department_name, unsigned short department_code,
            unsigned short regular_attendance, unsigned short required_ects,
            unsigned short mandatory_courses);
  ...
  /* - Student Management - */
  student *createStudent();                               // Creates a student object and adds it to the database.
  ...
  professor *createProfessor();                           // Creates a professor object and adds it to the database.
