...
interface::SHOULD_EXIT interface::studentManagement() {
  ...
  while (true) {
    ...
    /* - menu print - */
    this->output << "|" << std::endl << "|---------------- Student Management Menu ----------------|" << std::endl;
...
interface::SHOULD_EXIT studentModification(interface &interface, student *student) {
  ...
  while (true) {
    ...
    /* - menu print - */
    interface.output << "|" << std::endl << "|------- Modifying Student with ID: " << student->getFormattedUniID() << " -------|" << std::endl;
    ...
    interface.output << "5. Print Student Parameters" << std::endl;
    interface.output << "6. Return to Student Management Menu" << std::endl;
