...
interface::SHOULD_EXIT courseModification(interface& interface, course* course) {
    ...
    while (true) {
        ...
        interface.output << "|" << std::endl
                         << "|------- Modifying Course with ID: " << course->getFormattedUniID() << " -------|" << std::endl;
        ...
        case 5: {
            ...
            if (prof != nullptr) {
                interface.output << "|"
                                 << "| Professor with the following credentials was found: " << std::endl;
        ...
        case 6: {
            ...
            if (stud != nullptr) {
                interface.output << "|"
                                 << "| Student with the following credentials was found: " << std::endl;
